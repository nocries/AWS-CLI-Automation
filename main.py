...
def aws_cli():
  ...
  if test == "{'choice': 'Create a Key Pair'}":
    ...
    os.system(keypaircommand)
#install AWS Cli
  elif test == "{'choice': 'Install AWS CLI'}":
      install1= ("curl https://awscli.amazonaws.com/awscli-exe-linux-x86_64.zip -o awscliv2.zip")
      install2=("unzip awscliv2.zip")
      install3=("sudo ./aws/install")
      install4=("aws --version")
      install5=("aws configure")
      os.system(install1)
      os.system(install2)
      os.system(install3)
      os.system(install4)
  ...
  #create bucket
    ...
    os.system(bucketcommand)  
    os.system(bucketcommand1)
